...
export default function ScrollScene() {
  ...
  useEffect(() => {
    function tick() {
      ...
      // ─── Fan layout — cards pushed lower toward bottom ───────────
      // Bigger radius = more gap between cards when fanned (was 0.10, 115, 155)
      const RADIUS = clamp(vw * 0.13, 150, 210)
      const cardHalf = clamp(vh * 0.155, 155, 175)
      const stageCenterY = vh / 2
      const gapBelowText = 60   // extra gap below headline before cards start

      // fanCenterY: directly set where the fan center sits in the viewport
      // Smaller number = higher up. vh * 0.30 = 30% down from top of viewport
      const fanCenterY = vh * 0.30
      const stackY = fanCenterY - RADIUS

      const heroEndY = vh * 0.1201
      ...
      // ── CTA button ──────────────────────────────────────────────
      if (ctaRef.current) {
        const cP = range(raw, 0.40, 0.65)
        ctaRef.current.style.opacity = String(cP)
        ctaRef.current.style.transform = `translateY(${lerp(20, 0, cP)}px)`
      }
      ...
      CARDS.forEach((card, i) => {
        ...
        const cardFanP = isAnchor ? 0 : range(raw, 0.64 + (i % 4) * 0.025, 0.98)
  ...
  return (
    <div className="ss-wrap" ref={wrapRef}>
      <div className="ss-sticky">
        ...
        <div className="ss-hero-bg">
          <nav className="hero-nav">
            ...
            <div className="nav-logo">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="#f5e642"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2v8zm4 0h-2V8h2v8z"/></svg>
              BUDDIEFOOD
            </div>
          ...
          {/* White drip at bottom of hero */}
          <div className="hero-drip" aria-hidden="true">
            <svg viewBox="0 0 1440 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0,120 L0,70 Q50,70 50,42 Q50,16 72,16 Q94,16 94,42 Q94,70 144,70
                       Q194,70 194,38 Q194,8 218,8 Q242,8 242,38 Q242,70 296,70
                       Q346,70 346,44 Q346,16 370,16 Q394,16 394,44 Q394,70 446,70
                       Q496,70 496,50 Q496,26 520,26 Q544,26 544,50 Q544,70 596,70
                       Q650,70 650,38 Q650,8 674,8 Q698,8 698,38 Q698,70 752,70
                       Q806,70 806,42 Q806,16 828,16 Q850,16 850,42 Q850,70 902,70
                       Q952,70 952,44 Q952,16 976,16 Q1000,16 1000,44 Q1000,70 1052,70
                       Q1104,70 1104,50 Q1104,26 1128,26 Q1152,26 1152,50 Q1152,70 1204,70
                       Q1256,70 1256,38 Q1256,8 1278,8 Q1300,8 1300,38 Q1300,70 1354,70
                       Q1406,70 1406,42 Q1406,16 1426,20 Q1440,24 1440,70
                       L1440,120 Z" fill="#ffffff" />
            </svg>
          </div>
        </div>
        ...
        {/* ══ STRATEGY WHITE BG ══ */}
        <div
          className="ss-strat-bg"
          ref={stratBgRef}
          style={{ transform: 'translateY(100%)', opacity: 0 }}
        >
          <div className="strat-drip-top" aria-hidden="true">
            <svg viewBox="0 0 1440 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0,0 L0,50 Q50,50 50,80 Q50,106 72,106 Q94,106 94,80 Q94,50 144,50
                       Q194,50 194,84 Q194,112 218,112 Q242,112 242,84 Q242,50 296,50
                       Q346,50 346,78 Q346,106 370,106 Q394,106 394,78 Q394,50 446,50
                       Q496,50 496,70 Q496,92 520,92 Q544,92 544,70 Q544,50 596,50
                       Q650,50 650,84 Q650,112 674,112 Q698,112 698,84 Q698,50 752,50
                       Q806,50 806,80 Q806,106 828,106 Q850,106 850,80 Q850,50 902,50
                       Q952,50 952,78 Q952,106 976,106 Q1000,106 1000,78 Q1000,50 1052,50
                       Q1104,50 1104,70 Q1104,92 1128,92 Q1152,92 1152,70 Q1152,50 1204,50
                       Q1256,50 1256,84 Q1256,112 1278,112 Q1300,112 1300,84 Q1300,50 1354,50
                       Q1406,50 1406,80 Q1406,106 1426,100 Q1440,96 1440,50
                       L1440,0 Z" fill="#1e7d3a" />
            </svg>
          </div>
          ...
          <div className="strat-text" ref={stratTextRef}>
            <h2
              className="strat-headline"
              ref={headlineRef}
              style={{ opacity: 0, transform: 'translateY(28px)' }}
            >
              {/* FOOD THAT<br /> */}
              <span className="hl-red">GETS DELIVERED</span> EVERY<br />
              TIME YOUR supplies
            </h2>
            <p
              className="strat-sub"
            ...
            {/* <div
              ...
              style={{ opacity: 0, transform: 'translateY(20px)' }}
            >
              <button className="cta-pill-green">
                Order now &nbsp;
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{verticalAlign:'middle'}}><path d="M5 12h14M12 5l7 7-7 7"/></svg>
              </button>
            </div> */}
          </div>
        </div>
        ...
        <div className="ss-cards-layer">
          ...
          {/* <div
            className="ss-badge"
            ref={badgeRef}
            style={{ transform: 'translate(-50%, 60px) scale(0)', opacity: 0 }}
          >
            <span>🍔</span>
